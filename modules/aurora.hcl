...
inputs = {
  ...
  db_cluster_parameter_group_name            = "${local.global_vars.locals.project_name}-${local.env}-custom-group"
  db_cluster_parameter_group_description     = "Allow Audit of Database activities"
  db_cluster_parameter_group_family          = "aurora-mysql8.0"
  create_db_parameter_group                  = true
  db_parameter_group_name                    = "${local.global_vars.locals.project_name}-${local.env}-db-custom-group"
  ...
  db_cluster_parameter_group_use_name_prefix = false
  db_cluster_parameter_group_name            = "${local.global_vars.locals.project_name}-${local.env}-cluster-custom-group"
  db_cluster_parameter_group_family          = "aurora-mysql8.0"
  db_cluster_parameter_group_description     = "Allow Audit of Database activities"
